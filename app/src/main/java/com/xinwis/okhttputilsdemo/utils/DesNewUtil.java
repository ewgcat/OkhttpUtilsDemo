package com.xinwis.okhttputilsdemo.utils;
...
public class DesNewUtil {
    ...
    /** 安全密钥 */
    private static String keyData = "POLY_SECRET_KEY";
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        String value = "jasonToHappy";
        String key = "hengte";
        System.out.println(encrypt(value)+","+decrypt(encrypt(value)));
    }
